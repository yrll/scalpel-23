...
public class Prefix6 implements Comparable<Prefix6>, Serializable {
    ...
    public Prefix6(Ip6 address, Ip6 mask) {
        if (address == null) {
            throw new IllegalArgumentException("Cannot create prefix6 with null network");
        }
        if (mask == null) {
            throw new IllegalArgumentException("Cannot create prefix6 with null mask");
        }
        _address = address;
    ...
    public static @Nonnull Prefix6 parse(String text) {
        ...
        if (parts.length != 2) {
            throw new IllegalStateException("Invalid Prefix6 string: \"" + text + "\"");
        }
        ...
        try {
            ...
            throw new IllegalStateException("Invalid Prefix6 length: \"" + parts[1] + "\"", e);
        }
    }
