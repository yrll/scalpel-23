...
import org.sng.datamodel.ErrorFlow;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 初始化
        IgpDiagnosis igpDiagnosis = initIgpDiagnosis();
...
//        errorFlowList.add(new ErrorFlow("CSG1-1-1", Prefix.parse("110.0.0.8/32")));
        ...
        for (ErrorFlow errorFlow: errorFlowList){
            ...
            igpDiagnosis.igpDiagnosis(errorFlow);
        }
    }

    // 从JSON文件中初始化IGP诊断所需信息
    private static IgpDiagnosis initIgpDiagnosis() throws IOException {
        ...
        return new IgpDiagnosis(layer1Topology,commonFwdGraph,prefixEdgesMap,directRouteDevicesMap);
