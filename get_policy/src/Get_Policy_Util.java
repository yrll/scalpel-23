...
public class Get_Policy_Util {
    ...
    public void get_result(String dev, String policy){
        //fileName改成自己存放配置的目录
        setDev(dev);
        setPolicy(policy);
        String fileName = "C:\\Users\\31139\\IdeaProjects\\get_policy\\src\\ISIS\\Case1.1\\" +dev + ".cfg";
        System.out.println("filename:"+fileName);

        String route_policy = "route-policy "+policy;
...
//            System.out.println(route_policy_map);
            this.route_policy_map = route_policy_map;
            reader.close();
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
    ...
    public static void main(String[] args){
        ...
        g1.get_result("ASG3", "from-csg-as-master");//输入配置文件名和策略名称policy
